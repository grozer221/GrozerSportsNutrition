...
export class FilesResolver {
    ...
    @Mutation(() => File)
    async createFile(@Args('createFileInput') createFileInput: CreateFileInput): Promise<File> {
    ...
    async getFiles(
        ...
        return await this.filesService.getAsync(getFilesInput.take, getFilesInput.skip);
    }
